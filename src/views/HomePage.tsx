...
export default function HomeContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 py-16 px-6">
      <motion.div
                ...
                <div className="group relative bg-white dark:bg-slate-800 rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className={`px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r ${component.color} text-white`}>
                        {component.badge}
                      </span>
                    </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-slate-800 dark:text-white">Educativo</h3>
            ...
            <div className="text-center">
              <div className="text-4xl mb-4">🎨</div>
              <h3 className="text-xl font-semibold mb-2 text-slate-800 dark:text-white">Intuitivo</h3>
              <p className="text-slate-600 dark:text-slate-300">
            ...
            <div className="text-center">
              <div className="text-4xl mb-4">🚀</div>
              <h3 className="text-xl font-semibold mb-2 text-slate-800 dark:text-white">Interactivo</h3>
              <p className="text-slate-600 dark:text-slate-300">
